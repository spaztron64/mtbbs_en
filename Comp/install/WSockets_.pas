...
VCL Classes in this Unit:
  ...
  TTCPServer - A TCP Server (derived from TCustomWSocket_)
  TUDPClient - A UDP Client (derived from TCustomWSocket_)
  TUDPServer - A UDP Server (derived from TCustomWSocket_)

Other classes ni this Unit:
  TCustomWSocket_ - A generic base class for other socket classes
...
type
  ...
  TCustomWSocket_ = class(TComponent)
  private
  ...
  public
    ...
    function SocketToInAddr(Socket: TSocket): TInAddr;
    ...
    function PeerToInAddr(Socket: TSocket): TInAddr;
  ...
  TTCPClient = class(TCustomWSocket_)
  private
    FHandle: HWND;
  ...
  TTCPServer = class(TCustomWSocket_)
  private
    FHandle: HWND;
    FPort: string;
  ...
  TUDPClient = class(TCustomWSocket_)
  private
    FHandle: HWND;
  ...
  TUDPServer = class(TCustomWSocket_)
  private
    FHandle: HWND;
    FPort: string;
...
procedure Register;
begin
  RegisterComponents('myo', [TTCPClient, TTCPServer, TUDPClient, TUDPServer]);
end;
...
(**** TCustomWSocket_ Class ****)

constructor TCustomWSocket_.Create(AOwner: TComponent);
var
  WSAData: TWSAData;
begin
...
destructor TCustomWSocket_.Destroy;
begin
...
function TCustomWSocket_.GetSockAddrIn(
...
function TCustomWSocket_.GetAnySockAddrIn(
...
function TCustomWSocket_.GetBroadcastSockAddrIn(
         Port: string; var SockAddrIn: TSockAddrIn): boolean;
var
  ProtoEnt: PProtoEnt;
  ServEnt: PServEnt;
...
function TCustomWSocket_.SockAddrInToName(SockAddrIn: TSockAddrIn): string;
var
  HostEnt: PHostEnt;
begin
...
function TCustomWSocket_.SockAddrInToAddress(SockAddrIn: TSockAddrIn): string;
begin
  Result:= inet_ntoa(SockAddrIn.sin_addr);
end;

function TCustomWSocket_.SockAddrInToPort(SockAddrIn: TSockAddrIn): string;
begin
  Result:= IntToStr(ntohs(SockAddrIn.sin_port));
end;

function TCustomWSocket_.SocketToName(Socket: TSocket): string;
var
...
function TCustomWSocket_.SocketToAddress(Socket: TSocket): string;
var
  SockAddrIn: TSockAddrIn;
  Len: integer;
begin
...
function TCustomWSocket_.SocketToInAddr(Socket: TSocket): TInAddr;
var
  SockAddrIn: TSockAddrIn;
  Len: integer;
begin
  if Socket <> INVALID_SOCKET then
    begin
      Len:= SizeOf(SockAddrIn);
      if getsockname(Socket, SockAddrIn, Len) <> SOCKET_ERROR then
        Result:= SockAddrIn.sin_addr;
    end;
end;

function TCustomWSocket_.SocketToPort(Socket: TSocket): string;
var
  SockAddrIn: TSockAddrIn;
  Len: integer;
begin
...
function TCustomWSocket_.PeerToName(Socket: TSocket): string;
var
  SockAddrIn: TSockAddrIn;
  Len: integer;
  HostEnt: PHostEnt;
...
function TCustomWSocket_.PeerToAddress(Socket: TSocket): string;
var
  SockAddrIn: TSockAddrIn;
  Len: integer;
begin
...
function TCustomWSocket_.PeerToInAddr(Socket: TSocket): TInAddr;
var
  SockAddrIn: TSockAddrIn;
  Len: integer;
begin
...
function TCustomWSocket_.PeerToPort(Socket: TSocket): string;
var
  SockAddrIn: TSockAddrIn;
  Len: integer;
begin
...
procedure TCustomWSocket_.SocketClose(var Socket: TSocket; Handle: HWND);
var
  RC: integer;
begin
  if Socket <> INVALID_SOCKET then
...
function TCustomWSocket_.SocketQueueSize(Socket: TSocket): longint;
var
  Size: longint;
begin
  Result:= 0;
...
procedure TCustomWSocket_.SocketWrite(Socket: TSocket; Flag: integer; Data: string);
var
...
function TCustomWSocket_.SocketRead(Socket: TSocket; Flag: integer): string;
var
  Received: longint;
begin
  Result:= '';
...
function TCustomWSocket_.SocketWriteBuffer(Socket: TSocket; Buffer: Pointer; Size, Flag: integer): integer;
begin
...
function TCustomWSocket_.SocketReadBuffer(Socket: TSocket; Buffer: Pointer; Size, Flag: integer): integer;
begin
...
procedure TCustomWSocket_.SocketWriteTo(Socket: TSocket; Flag: integer; Data: string; var SockAddrIn: TSockAddrIn);
var
  TotSent, ToSend, Sent, ErrorLoop: integer;
begin
  if Data <> '' then
...
function TCustomWSocket_.SocketReadFrom(Socket: TSocket; Flag: integer; var SockAddrIn: TSockAddrIn): string;
var
  Len: integer;
  Received: longint;
begin
...
function TCustomWSocket_.SocketWriteBufferTo(Socket: TSocket; Buffer: Pointer; Size, Flag: integer; var SockAddrIn: TSockAddrIn): integer;
begin
...
function TCustomWSocket_.SocketReadBufferFrom(Socket: TSocket; Buffer: Pointer; Size, Flag: integer; var SockAddrIn: TSockAddrIn): integer;
var
  Len: integer;
begin
  Len:= SizeOf(SockAddrIn);
...
procedure TCustomWSocket_.SocketError(Error: integer);
begin
  FLastError:= Error;
...
function TCustomWSocket_.LastErrorDesc: string;
begin
  case FLastError of
...
function TCustomWSocket_.GetLocalHostAddress: string;
var
  SockAddrIn: TSockAddrIn;
  HostEnt: PHostEnt;
...
function TCustomWSocket_.GetLocalHostName: string;
var
  szHostName: array[0..128] of char;
begin
  if gethostname(szHostName, 128) = 0 then
